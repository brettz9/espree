 ...
 * @typedef {typeof import('./acornhelper').AcornParser} AcornParser
 * @typedef {typeof import('./acornhelper').EspreeParser} EspreeParser
 ...
 * @typedef {import('./acornhelper').ParserOptions} ParserOptions
 */
...
export default () => /** @param {AcornParser} Parser */ Parser => {
