 ...
 * @typedef {import('../espree').StateObject} StateObject
 * @typedef {import('../espree').StateObjectWithTokens} StateObjectWithTokens
 * @typedef {import('../espree').EnhancedTokTypes} EnhancedTokTypes
 * @typedef {import('../espree').EsprimaComment} EsprimaComment
 * @typedef {import('../espree').EspreeTokens} EspreeTokens
 * @typedef {import('../espree').FixedAcornNode} FixedAcornNode
 * @typedef {import('../espree').EsprimaNode} EsprimaNode
...
export class EspreeParser extends acorn.Parser {
    ...
    /**
     * Parse
     * @returns {EsprimaProgramNode} The Esprima program Node
     */
    parse() {
...
/**
 * Dummy class for TypeScript generation
 */
export class AcornParser extends acorn.Parser {

    /* eslint-disable camelcase, class-methods-use-this, no-unused-vars */
    /**
     * In Acorn JSX but not its *.d.ts
     * @param {number} quote The number
     * @returns {void}
     */
    jsx_readString(quote) {
    }

    /* eslint-enable camelcase, class-methods-use-this, no-unused-vars */
}

/* eslint-disable no-undefined */
// Added by acorn-jsx plugin
AcornParser.acornJsx = /** @type {{
...
export default () => {
     ...
     * @param {typeof AcornParser} Parser The Acorn parser
