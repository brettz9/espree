...
export default () => {
    ...
    // `EspreeParser` type will be auto-built based on class below
    /**
     * @typedef {{
     *   new (opts: import('../espree').ParserOptions | null, code: string | object): EspreeParser
     ...
     * @returns {EspreeParserCtor} The Espree parser
     */
    return Parser => {
